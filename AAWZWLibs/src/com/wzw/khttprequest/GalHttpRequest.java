...
import com.wzw.khttprequest.GalDownLoadTask.GalDownLoadTaskListener;
        ...
        */ 
        ...
        private HttpResponse requestHttp(boolean haveLastModified, boolean haveEtag) {
                ...
                try {
                        if (galurl.getPostData().size() > 0) {
                                ...
                                request.addHeader("Cookie", this.getCookiesString());
                ...
                if (response!=null) {
                    ...
                    for (int i = 0; i < setcookies.length; i++) {
    					Header cookieHeader = setcookies[i];
    					String[] cookieStrings = cookieHeader.getValue().split(";");
    					for (int j = 0; j < cookieStrings.length; j++) {
    						String cookiekv = cookieStrings[j].trim();
        ...
        private String getCookiesString(){
        	...
        	while(iterator.hasNext()){
        		...
        		cookie=cookie+key+"="+cookies.get(key);
			}
        	return cookie;
        }
